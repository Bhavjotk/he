...
yes.addEventListener("click", () => {
  ...
  gif.src = "./resources/crying.gif";// gif credit: https://tenor.com/view/peach-cat-kiss-animated-love-mwah-gif-25743978
  text.innerHTML = "Knew it HAYATIIIIII 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/bhavjotsk/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
